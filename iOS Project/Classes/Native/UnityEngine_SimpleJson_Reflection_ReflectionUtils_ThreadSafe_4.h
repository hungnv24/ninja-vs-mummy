...
struct ThreadSafeDictionaryValueFactory_2_t390;
...
struct  ThreadSafeDictionary_2_t391  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t390 * ____valueFactory_1;
