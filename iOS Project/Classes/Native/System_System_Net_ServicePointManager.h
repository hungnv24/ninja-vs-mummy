...
struct ICertificatePolicy_t558;
...
struct  ServicePointManager_t559  : public Object_t
{
};
struct ServicePointManager_t559_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t519 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t544 * ___server_cert_cb_9;
};
