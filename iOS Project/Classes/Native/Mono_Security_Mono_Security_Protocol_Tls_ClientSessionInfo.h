...
struct  ClientSessionInfo_t830  : public Object_t
{
	...
	ByteU5BU5D_t145* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t145* ___masterSecret_5;
};
struct ClientSessionInfo_t830_StaticFields{
